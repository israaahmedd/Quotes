...
function generateQuote(){
    ...
    var arrayIndex = Math.floor(Math.random() * quotesArr.length);
     document.getElementById("quote").innerHTML = quotesArr[arrayIndex].quote;
     document.getElementById("author").innerHTML = quotesArr[arrayIndex].author;
